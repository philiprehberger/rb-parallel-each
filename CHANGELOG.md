...
- `ParallelEach.last_stats` returning a Hash with `workers`, `completed`, `failed`, and `elapsed_seconds` from the most recent parallel run
- `WorkerPool#stats` accessor exposing per-executor stats (workers, completed, failed, elapsed_seconds)
- `.github/FUNDING.yml` metadata for GitHub Sponsors
...
[Unreleased]: https://github.com/philiprehberger/rb-parallel-each/compare/v0.5.0...HEAD
[0.5.0]: https://github.com/philiprehberger/rb-parallel-each/compare/v0.4.0...v0.5.0
[0.4.0]: https://github.com/philiprehberger/rb-parallel-each/compare/v0.3.0...v0.4.0
